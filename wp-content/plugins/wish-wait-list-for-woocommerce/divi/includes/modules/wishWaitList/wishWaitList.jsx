...
class BAWWwishWait extends Component {

  static slug = 'et_pb_br_wish_wait';
  static parameters = ['list',
            'header',
            'expand'];
  constructor(props) {
    super(props);
  ...
  componentDidUpdate(oldProps) {
      var update = false;
      BAWWwishWait.parameters.forEach(key => {
  ...
  componentDidMount() {
    ...
    body.append('action', 'brww_wish_wait');
